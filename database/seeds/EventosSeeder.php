...
class EventosSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('canciones')->insert(['titulo'=>'Vas a Volver (part. Ugo Rodríguez)','banda'=>3,'created_at'=>date('Y-m-d H:m:s'),'updated_at'=>date('Y-m-d H:m:s')]);
        ...
        DB::table('canciones')->insert(['titulo'=>'Tú, mujer','banda'=>5,'created_at'=>date('Y-m-d H:m:s'),'updated_at'=>date('Y-m-d H:m:s')]);
        ...
        DB::table('canciones')->insert(['titulo'=>'Tell Me Lies - Radio Edit','banda'=>9,'created_at'=>date('Y-m-d H:m:s'),'updated_at'=>date('Y-m-d H:m:s')]);
        ...
        DB::table('canciones')->insert(['titulo'=>'Tell Me Lies','banda'=>9,'created_at'=>date('Y-m-d H:m:s'),'updated_at'=>date('Y-m-d H:m:s')]);
        DB::table('canciones')->insert(['titulo'=>'Te Quedaste (Acústico en Vivo Bar el Olvido)','banda'=>9,'created_at'=>date('Y-m-d H:m:s'),'updated_at'=>date('Y-m-d H:m:s')]);
        DB::table('canciones')->insert(['titulo'=>'Sunday Funday','banda'=>9,'created_at'=>date('Y-m-d H:m:s'),'updated_at'=>date('Y-m-d H:m:s')]);
        DB::table('canciones')->insert(['titulo'=>'Sunday Funday (Radio Edit)','banda'=>9,'created_at'=>date('Y-m-d H:m:s'),'updated_at'=>date('Y-m-d H:m:s')]);
