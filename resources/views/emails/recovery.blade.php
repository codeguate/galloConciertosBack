<html>
  ...
  <body style="margin: 0px;">
    <div style="margin: auto;width: 100vw;height: auto;display: flex;background-image: url(http://documentos.devcodegt.com/gallo/fondo-canciones.png);background-size: auto 100%;background-repeat: no-repeat;">
      <div style="width: 100vw;height: 100vh;text-align: center;background-color: #922c2a99;margin-top: 0px;color: #ffffff;">
        <img src="http://documentos.devcodegt.com/gallo/logo.png" style="height: 30vh;width: auto;margin-top: 25px;">
