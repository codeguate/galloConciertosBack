<html>
  ...
  <body style="margin: 0px;">
    <div style="margin: auto;width: 100vw;height: auto;display: flex;background-image: url(http://test.codeguate.com/gallo/fondo-canciones.png);background-size: 100% 100%;">
